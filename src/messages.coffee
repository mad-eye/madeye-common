...
messageAction =
  ...
  SAVE_LOCAL_FILE : 'saveLocalFile'
  LOCAL_FILE_SAVED : 'localFileSaved'
  ADD_LOCAL_FILES : 'addLocalFiles'
  LOCAL_FILES_ADDED : 'localFilesAdded'
  REMOVE_LOCAL_FILES : 'removeLocalFiles'
  LOCAL_FILES_REMOVED : 'localFilesRemoved'
